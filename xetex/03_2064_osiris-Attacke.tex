...
\addchap{2064 -- OSIRIS-Attacke} % (fold)
...
\deleted{OSIRIS hatte daraufhin sofort einige  Missionen hinzufügt, um Lilly zu fangen, und viele Spieler nahmen diese Missionen an.}
\added{Sofort wurden in OSIRIS einige \added{neue} Missionen hinzufügt, um Lilly zu fangen, und viele Spieler nahmen die Jagd auf Lilly auf.}
