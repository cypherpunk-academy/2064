== [big-number]#2020# Sharing is Caring
...
Das ist wichtig, dass in den PRgrammen keine Lücken mehr sind, bevor die Sache richtig groß wird.
...
„Ok, so ... die Nachrichten an die ersten sechs Teams sind raus.
...
Nicht so schwierig.
Dreiviertelstunde.
Dann teste ich es mit ein paar Tausend QR-Codes, ist ok, mache ein Image davon und schicke es über Pond an Anita.
