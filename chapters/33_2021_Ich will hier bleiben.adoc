== [big-number]#2021# Ich will hier bleiben
...
Wir sind jetzt hier.
Das öffnet das Fenster für einige Möglichkeiten.
...
„Sudo ist hier!“, schreckte Lasse auf, um dann aber sofort wieder abzuwiegeln.
