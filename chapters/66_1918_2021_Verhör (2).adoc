== [big-number]#2023, 1918# Verhör (2)

[text-caps]#Ein schmutziges Straßen-Café# in einer Geschäftsstraße irgendwo in Addis-Abbeba. Marlene saß in einer Ecke, halb hinter einer Säule und trank einen Tee.
