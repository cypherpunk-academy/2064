...
Und wenn Gesetze die Geheimhaltung von Dokumenten erlauben, die sehr wichtig für die Öffentlichkeit sind, dann ist das auch ein Fehler, wie ein Fehler in einem Computerprogramm.
