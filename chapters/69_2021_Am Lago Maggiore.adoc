...
Die Kaffeemaschine analysierte wie aktiv man gerade in OpenSource-Projekten auf Github war und wenn es ihr nicht genug war, dann musste man einen der Tricks finden, sie doch zum Kochen zu bewegen.
