...
Sie lehnte sich zurück und dachte an die anstrengende Reise von Berlin bis zu diesem Ort.
...
Das Einzige, was sie noch nicht herausbekommen hatte, aber unbedingt wissen wollte, war, wie es ihrem Bruder Paul ging.
