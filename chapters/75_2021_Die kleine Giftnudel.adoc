...
[text-caps]#Vor dem Haupteingang# der BND-Zentrale in Berlin hielt eine Fahrzeugkolonne aus gepanzerten Maybach- und Mercedes-Limousinen mit zwei Polizeiwagen an der Spitze und zwei am Ende.
Dort wartete bereits der Präsident des BND mit einigen Beamten.
Ein Beamter riss die hintere Türe der ersten Maybach-Limousine auf.
...
Er ballte symbolisch eine Faust.
